...
def get_best_actions(state, pos, max_x, max_y):
    (x, y) = pos
...
def can_move_same_direction(state, pos, max_x, max_y, direction):
    (x, y) = pos
...
class Enemy:
    ...
    def action(self, state):
        ...
        best_actions = get_best_actions(state, pos, max_x, max_y)
...
class SmarterEnemy:
    ...
    def action(self, state):
        ...
        if can_move_same_direction(state, pos, max_x, max_y, self.enemy.direction):
